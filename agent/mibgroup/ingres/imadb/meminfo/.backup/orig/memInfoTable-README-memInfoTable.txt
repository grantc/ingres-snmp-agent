...
------------------------------------------------------------------------
  ...
  the memInfoTable table.  The agent will start by looking for the right
  ...
  file defaults/table-memInfoTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      memInfoTable_allocate_data
      memInfoTable_release_data
 ...
 Index(es) for the memInfoTable table
  ------------------------------------------------------------
  The index(es) for the memInfoTable table are:
...
************************************************************************
memInfoTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the memInfoTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: memInfoTable_data_access.[c|h]
------------------------------------------------------------------------
  The memInfoTable_data_access file contains the interface to your data in
  ...
  FUNC : memInfoTable_indexes_set
  WHERE: memInfoTable_data_access.c
...
File: memInfoTable_data_get.c
------------------------------------------------------------------------
  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : memInfoBytesUsed_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : memInfoFreePages_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : memInfoGetPages_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : memInfoPagesUsed_get



File: memInfoTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the memInfoTable table.

To watch the flow of the memInfoTable table, use the
following debug tokens:

        snmp_agent
        helper:table:req
        memInfoTable
        verbose:memInfoTable
        internal:memInfoTable

e.g.
        snmpd -f -Le -DmemInfoTable,verbose:memInfoTable,internal:memInfoTable
...
/*---------------------------------------------------------------------
 * INGRES-MIB::memInfoEntry.memInfoServer
 * memInfoServer is subid 1 of memInfoEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.757.5.1.2.1.1
 * Description:
