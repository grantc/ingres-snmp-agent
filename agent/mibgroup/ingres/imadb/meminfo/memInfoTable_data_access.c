...
# include "meminfo.c"
/* # line 244 "memInfoTable_data_access.sc" */	/* host code */
    DEBUGMSGTL(("verbose:memInfoTable:memInfoTable_container_load",
                "called\n"));
    /*
     * open data connection.
     */
/* # line 252 "memInfoTable_data_access.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
...
/* # line 254 "memInfoTable_data_access.sc" */	/* host code */
        DEBUGMSGTL(("verbose:memInfoTable","Connected to database\n"));
/* # line 256 "memInfoTable_data_access.sc" */	/* execute procedure */
  {
    IIsqInit(&sqlca);
...
/* # line 257 "memInfoTable_data_access.sc" */	/* host code */
        DEBUGMSGTL(("verbose:memInfoTable","Vnode domain set\n"));
    /*
     ...
     * the container.
     */
/* # line 267 "memInfoTable_data_access.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"memInfocsr",4750,2555);
    IIwritio(0,(short *)0,1,32,0,(char *)"select * from ima_memory_inf\
o");
    IIwritio(0,(short *)0,1,32,0,(char *)" for readonly ");
    IIcsQuery((char *)"memInfocsr",4750,2555);
    if (sqlca.sqlcode < 0) 
      IIsqStop(&sqlca);
  }
/* # line 268 "memInfoTable_data_access.sc" */	/* host code */
        DEBUGMSGTL(("verbose:memInfoTable","Cursor opened\n"));
    while (1) {
/* # line 273 "memInfoTable_data_access.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"memInfocsr",4750,2555,0,0) != 0) {
      IIcsGetio((short *)0,1,32,64,(memInforec).memInfoServer);
      IIcsGetio((short *)0,1,30,sizeof((memInforec).memInfoBytesUsed),&
      (memInforec).memInfoBytesUsed);
      IIcsGetio((short *)0,1,30,sizeof((memInforec).memInfoFreePages),&
      (memInforec).memInfoFreePages);
      IIcsGetio((short *)0,1,30,sizeof((memInforec).memInfoGetPages),&
      (memInforec).memInfoGetPages);
      IIcsGetio((short *)0,1,30,sizeof((memInforec).memInfoPagesUsed),&
      (memInforec).memInfoPagesUsed);
      IIcsERetrieve();
    } /* IIcsRetrieve */
    if (sqlca.sqlcode == 100) 
      goto close_memInfocsr;
    else if (sqlca.sqlcode < 0) 
      IIsqStop(&sqlca);
  }
/* # line 274 "memInfoTable_data_access.sc" */	/* host code */
                DEBUGMSGTL(("verbose:memInfoTable","SQL fetched\n"));
                DEBUGMSGTL(("verbose:memInfoTable","Server %s\n",memInforec.memInfoServer));
                DEBUGMSGTL(("verbose:memInfoTable","Page Size %d\n",memInforec.memInfoPagesUsed));
        /*
         * parse strings into variables
         */
        strcpy(memInfoServer,memInforec.memInfoServer);
        memInfoServer_len = strlen(memInfoServer);
        /*
    ...
    /** no mapping */
        ...
        close_memInfocsr:
/* # line 350 "memInfoTable_data_access.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"memInfocsr",4750,2555);
    if (sqlca.sqlcode < 0) 
      IIsqStop(&sqlca);
  }
/* # line 353 "memInfoTable_data_access.sc" */	/* host code */
