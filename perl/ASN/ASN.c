 ...
 * contents of ASN.xs. Do not edit this file, edit ASN.xs instead.
 *
...
XS(XS_NetSNMP__ASN_constant); /* prototype to pass -Wmissing-prototypes */
XS(XS_NetSNMP__ASN_constant)
{
    dXSARGS;
    if (items != 2)
	Perl_croak(aTHX_ "Usage: NetSNMP::ASN::constant(sv, arg)");
    {
#line 335 "ASN.xs"
	STRLEN		len;
#line 350 "ASN.c"
...
extern "C"
#endif
XS(boot_NetSNMP__ASN); /* prototype to pass -Wmissing-prototypes */
XS(boot_NetSNMP__ASN)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("NetSNMP::ASN::constant", XS_NetSNMP__ASN_constant, file, "$$");
    XSRETURN_YES;
}
