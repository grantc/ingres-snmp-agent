...
------------------------------------------------------------------------
  ...
  the dmfTable table.  The agent will start by looking for the right
  ...
  file defaults/table-dmfTable.m2d, and then re-running mib2c.
    ...
    will be generated:
      ...
      dmfTable_allocate_data
      dmfTable_release_data
 ...
 Index(es) for the dmfTable table
  ------------------------------------------------------------
  The index(es) for the dmfTable table are:
...
************************************************************************
dmfTable File Overview
------------------------------------------------------------------------
  Several files have been generated to implement the dmfTable
  table. We'll go through these files, one by one, explaining each and
  letting you know which you need to edit.


File: dmfTable_data_access.[c|h]
------------------------------------------------------------------------
  The dmfTable_data_access file contains the interface to your data in
  ...
  FUNC : dmfTable_indexes_set
  WHERE: dmfTable_data_access.c
...
------------------------------------------------------------------------
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : ioWaitCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : groupBufferReadCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : groupBufferWriteCount_get
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : dirtyUnfixCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : pagesStillValid_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : pagesInvalid_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : bufferCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : pageBufferCount_get
  ...
  -------------------
  TODO : retrieve column data from raw data
  FUNC : hashBucketCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : groupBufferCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : groupBufferSize_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : cacheStatus_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : freeBufferCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : freeBufferWaiters_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : fixedBufferCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : modifiedBufferCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : freeGroupBufferCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : fixedGroupBufferCount_get

  Get data for column
  -------------------
  TODO : retrieve column data from raw data
  FUNC : modifiedGroupBufferCount_get



File: dmfTable_data_set.c
------------------------------------------------------------------------
...
NOTE: Depending on your configuration, some of the functions used in the
      ...
      were generated for the dmfTable table.

To watch the flow of the dmfTable table, use the
...
e.g.
        snmpd -f -Le -DdmfTable,verbose:dmfTable,internal:dmfTable
...
/*---------------------------------------------------------------------
 * INGRES-MIB::dmfEntry.server
 * server is subid 1 of dmfEntry.
 * Its status is Current, and its access level is ReadOnly.
 * OID: .1.3.6.1.4.1.757.5.1.1.1.1
 * Description:
 ...
 */
/*---------------------------------------------------------------------
 * INGRES-MIB::dmfEntry.pagesize
 * pagesize is subid 2 of dmfEntry.
 * Its status is Current, and its access level is ReadOnly.
