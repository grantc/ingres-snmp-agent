...
/* # line 244 "dmfTable_data_access.sc" */	/* host code */
     ...
     * open our data file.
     */
/* # line 255 "dmfTable_data_access.sc" */	/* connect */
  {
    IIsqInit(&sqlca);
...
/* # line 257 "dmfTable_data_access.sc" */	/* host code */
     ...
     * the container.
     */
/* # line 271 "dmfTable_data_access.sc" */	/* open */
  {
    IIsqInit(&sqlca);
    IIcsOpen((char *)"dmfcsr",23664,4349);
    IIwritio(0,(short *)0,1,32,0,(char *)
"select * from ima_dmf_cache_stats");
    IIwritio(0,(short *)0,1,32,0,(char *)" for readonly ");
    IIcsQuery((char *)"dmfcsr",23664,4349);
    if (sqlca.sqlcode < 0) 
      IIsqStop(&sqlca);
  }
/* # line 272 "dmfTable_data_access.sc" */	/* host code */
    ...
    while (1) {
/* # line 279 "dmfTable_data_access.sc" */	/* host code */
        //do {
/* # line 280 "dmfTable_data_access.sc" */	/* fetch */
  {
    IIsqInit(&sqlca);
    if (IIcsRetScroll((char *)"dmfcsr",23664,4349,0,0) != 0) {
...
/* # line 281 "dmfTable_data_access.sc" */	/* host code */
	...
	DEBUGMSGTL(("verbose:dmfTable","Index set\n"));
         ...
         */
    /** no mapping */
        rowreq_ctx->data.fixCount = dmfrec.fix_count;
        DEBUGMSGTL(("verbose:dmfTable","Fix Count row assigned %d\n",dmfrec.fix_count));
        /*
        ...
        close_dmfcsr:
/* # line 347 "dmfTable_data_access.sc" */	/* close */
  {
    IIsqInit(&sqlca);
    IIcsClose((char *)"dmfcsr",23664,4349);
    if (sqlca.sqlcode < 0) 
      IIsqStop(&sqlca);
  }
/* # line 348 "dmfTable_data_access.sc" */	/* host code */
//        break;
    /*
     ***************************************************
     ***             START EXAMPLE CODE              ***
