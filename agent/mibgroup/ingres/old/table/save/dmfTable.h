...
config_require(ingres/table/dmfTable_interface)
config_require(ingres/table/dmfTable_data_access)
config_require(ingres/table/dmfTable_data_get)
config_require(ingres/table/dmfTable_data_set)
    /* *INDENT-ON*  */
...
/**********************************************************************/
    ...
    typedef struct dmfTable_data_s {
         ...
         */
        char            processID[65535];
        size_t          processID_len;  /* # of char elements, not bytes */
