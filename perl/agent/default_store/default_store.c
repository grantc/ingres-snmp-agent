...
#line 618 "default_store.c"

XS(XS_NetSNMP__agent__default_store_constant); /* prototype to pass -Wmissing-prototypes */
XS(XS_NetSNMP__agent__default_store_constant)
{
    dXSARGS;
    if (items != 1)
	Perl_croak(aTHX_ "Usage: NetSNMP::agent::default_store::constant(sv)");
    SP -= items;
    {
#line 613 "default_store.xs"
#ifdef dXSTARG
...
#line 639 "default_store.c"
	SV *	sv = ST(0);
	const char *	s = SvPV(sv, len);
#line 627 "default_store.xs"
...
extern "C"
#endif
XS(boot_NetSNMP__agent__default_store); /* prototype to pass -Wmissing-prototypes */
XS(boot_NetSNMP__agent__default_store)
{
    dXSARGS;
    char* file = __FILE__;
    ...
    XS_VERSION_BOOTCHECK ;
        ...
        newXSproto("NetSNMP::agent::default_store::constant", XS_NetSNMP__agent__default_store_constant, file, "$");
    XSRETURN_YES;
}
