...
dmfTable_container_load(netsnmp_container * container)
{
	...
	exec sql begin declare section;
		exec sql include 'ima/dmfcache.dcl';
	...
	EXEC SQL WHENEVER NOT FOUND GOTO close_dmfcsr; //allows break out of 'do' loop
		
        do {
	EXEC SQL FETCH dmfcsr INTO :dmfrec;
