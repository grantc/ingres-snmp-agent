...
memInfoTable_container_load(netsnmp_container * container)
{
    ...
    size_t          memInfoServer_len;
        ...
        exec sql begin declare section;
                exec sql include 'meminfo.dcl';
        exec sql end declare section;

        EXEC SQL DECLARE memInfocsr CURSOR FOR
                select *
                from
                ima_memory_info;
     ...
     */
        ...
        EXEC SQL OPEN memInfocsr FOR READONLY;
        DEBUGMSGTL(("verbose:memInfoTable","Cursor opened\n"));

    while (1) {
        EXEC SQL WHENEVER NOT FOUND GOTO close_memInfocsr ;

        EXEC SQL FETCH memInfocsr INTO :memInforec;
