...
begin with the memInfoTable prefix.
...
------------------------------------------------------------------------
  ...
  Editable: Optional
  Usage   : make -f memInfoTable_Makefile


  File    : memInfoTable_subagent.c
  ----------------------------------------------------------------------
...
should probably read these next:
   ...
   memInfoTable-README-memInfoTable.txt
