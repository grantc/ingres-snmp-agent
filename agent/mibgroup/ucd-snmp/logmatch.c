...
init_logmatch(void)
{
    ...
    struct variable2 logmatch_table[] = {
        ...
        {LOGMATCH_REGMSG, ASN_OCTET_STR, RONLY, var_logmatch_table, 1, {102}},
    };
        ...
        if ((logmatchTable[iindex].logfile =
            ...
            while (fgets
                ...
                if (matchResultCode == 0) {
					...
					strcpy(logmatchTable[iindex].regmsg, inbuf);
                    anyChanges = TRUE;
                }
            }
                   ...
                   size_t * var_len, WriteMethod ** write_method)
{
	...
	/* Ingres: added to get back the error message */
    case LOGMATCH_REGMSG:

        *var_len = strlen(logmatch->regmsg);
        return (u_char *) logmatch->regmsg;
